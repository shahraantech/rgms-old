                ...
                success: function(data) {
                    ...
                    for (i = 0; i < data.length; i++) {
                        ...
                        html += '<tr>' +
                            ...
                            '<a href="edit-company/' + data[i].id + '" class="dropdown-item btn_edit_clients" id="btn_edit_clients"><i class="fa fa-pencil m-r-5n "></i> Edit</a>' +
                            '<a href="" class="dropdown-item btn_delete_company" data="' + data[i].id + '" id="btn_delete_clients"><i class="fa fa-trash-o m-r-5 "></i> Delete</a>' +
                            '</tr>';
                    }
