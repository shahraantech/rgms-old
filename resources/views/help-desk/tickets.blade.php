                ...
                <div class="card-body">
                    <form action="{{ url('ticket') }}" method="post" id="searchForm">
                        ...
                        <div class="row filter-row">
                            ...
                            <div class="col-md-2 col-sm-4">
                                <button class="btn btn-primary btn-block btn_search_tic" type="submit"><i
        ...
        $(document).ready(function() {
                        ...
                        for (i = 0; i < data.length; i++) {
                            ...
                            html += '<tr>' +
                                ...
                                '<a class="dropdown-item btn-status" href="javascript:" data="' + data[
                                    i].id +
                                '" status="open"><i class="fa fa-clock-o m-r-5 text-success" ></i>Open</a>' +
                                '<a class="dropdown-item btn-status" href="javascript:" data="' + data[
                                    i].id +
                                '" status="decline"><i class="fa fa-clock-o m-r-5 text-danger" ></i>Decline</a>' +
                                '<a class="dropdown-item btn-status" href="javascript:" data="' + data[
                                    i].id +
                                '"  status="complete"><i class="fa fa-clock-o m-r-5 text-success"></i>Complete</a>' +
                                '<a class="dropdown-item btn-status" href="javascript:" data="' + data[
                                    i].id +
                                '"  status="pending"><i class="fa fa-clock-o m-r-5 text-danger"></i>Pending</a>' +
                                '</div>' +
                                ' </div>' +
                                '</td>' +
                                '</tr>';
            ...
            $('#searchForm').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    processData: false,
                    beforeSend: function() {
                        $('.btn_search_tic').text('Searching...');
                        $(".btn_search_tic").prop("disabled", true);
                    },
                    success: function(data) {
                        ...
                        for (i = 0; i < data.length; i++) {
                            (data[i].status == 'COMPLETE') ? status_class = 'bg-success':
                            ...
                            html += '<tr>' +
                                ...
                                '<tr>' +
                                '<td>' +
                                '<a class="ml-5" href="#">' + data[i].name + ' <span>' + data[i]
                                .desig_name + '</span></a>' +
                                '</td>'
                            '</tr>' +
                            '<td>' + data[i].subject + '</td>' +
                                ...
                                '" style="color:white"> ' + data[i].status + ' </span></td>' +
                                '<td class="text-right">' +
                                '<div class="dropdown dropdown-action">' +
                                '<a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="material-icons">more_vert</i></a>' +
                                '<div class="dropdown-menu dropdown-menu-right">' +
                        ...
                        $('#ticketTable').html(html);
                        $('.btn_search_tic').html('<i class="fa fa-search"><i>');
                        $(".btn_search_tic").prop("disabled", false);
