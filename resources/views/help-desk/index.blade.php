...
<script>
    $(document).ready(function() {
                ...
                success: function(data) {
                    ...
                    for (i = 0; i < data.length; i++) {
                        ...
                        html += '<tr>' +
                            ...
                            '<a href="#" class="dropdown-item btn_edit_ticket" data="' + data[i].id + '" id="btn_edit_clients"><i class="fa fa-pencil m-r-5n "></i> Edit</a>' +
                            '<a href="" class="dropdown-item btn_delete_ticket" data="' + data[i].id + '" id="btn_delete_clients"><i class="fa fa-trash-o m-r-5 "></i> Delete</a>' +
                            '</tr>';
                    }
        ...
        $('#ticketForm').unbind().on('submit', function(e) {
            e.preventDefault();
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('select[name="priority"]')
                        .append(`<option value="HIGH" ${'HIGH' == data.periorty ? 'selected' : ''}>HIGH</option>` +
