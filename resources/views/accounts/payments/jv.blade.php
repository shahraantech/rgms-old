...
@section('content')
    ...
    <div class="page-wrapper">
        ...
        <div class="content container-fluid">
            <div class="page-header my-header">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto float-right ml-auto">
                        <a href="#journal-vochars-list" class="btn add-btn" title="Journal Vochars List"><i
            ...
            <div class="card">
                <div class="card-body">
                    <form method="post" id="JvForm" action="{{ url('jv') }}">
                        @csrf
                        <div class="row">
                            <div class="col-sm-6">
                            ...
                            <div class="col-sm-6 de-cash-ac" style="display: none">
                                <div class="form-group">
                                    ...
                                    <select name="dr_cash_ac_id" id="" class="form-control selectpicker"
                            ...
                            <div class="col-sm-6 de-bank-ac" style="display: none">
                                <div class="form-group">
                                    <label>Banks</label>
                                    <select name="dr_bank_id" id="" class="form-control selectpicker"
                                        data-container="body" data-live-search="true" required>
                                        <option value="">Choose One</option>
                                        @isset($data['banks'])
                            ...
                            <div class="col-sm-6 de-client-ac" style="display: none">
                                <div class="form-group">
                                    ...
                                    <select name="dr_client_id" id="" class="form-control selectpicker"
                                        data-container="body" data-live-search="true" required>
                                        <option value="">Choose One</option>
                                        @isset($data['customer'])
                            ...
                            <div class="col-sm-6 de-vendor-ac" style="display: none">
                                <div class="form-group">
                                    <label>Vendors</label>
                                    <select name="dr_vendor_id" id="" class="form-control selectpicker"
                                        data-container="body" data-live-search="true" required>
                                        <option value="">Choose One</option>
                                        @isset($data['vendors'])
                            ...
                            <div class="col-sm-6 de-expense-ac" style="display: none">
                                <div class="form-group">
                                    ...
                                    <select name="dr_expense_id" id="" class="form-control selectpicker"
                                        data-container="body" data-live-search="true" required>
                                        <option value="">Choose One</option>
                                        @isset($data['level4'])
                            ...
                            <div class="col-sm-6 de-liability-ac" style="display: none">
                                <div class="form-group">
                                    ...
                                    <select name="dr_liability_id" id="" class="form-control selectpicker"
                                        data-container="body" data-live-search="true" required>
                                        <option value="">Choose One</option>
                            ...
                            <div class="col-sm-6 de-assets-ac" style="display: none">
                                <div class="form-group">
                                    <label>Assets</label>
                                    <select name="dr_assets_id" id="" class="form-control selectpicker"
                                        data-container="body" data-live-search="true" required>
                                        <option value="">Choose One</option>
                                        @isset($data['assets'])
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select name="creditor" id="" class="form-control selectpicker creditor"
                                        data-container="body" data-live-search="true" required>
                                        <option value="">Choose One</option>
                                        <option value="1">Cash A/C</option>
                                        <option value="2">Bank A/C</option>
                            ...
                            <div class="col-sm-6 cash-ac" style="display: none">
                                <div class="form-group">
                                    <label>Cash A/C</label>
                                    <select name="cr_cash_ac_id" id="" class="form-control selectpicker"
                                        data-container="body" data-live-search="true" required>
                                        <option value="">Choose One</option>
                                        @isset($data['accounts'])
                                            @foreach ($data['accounts'] as $accounts)
                            ...
                            <div class="col-sm-6 bank-ac" style="display: none">
                                <div class="form-group">
                                    <label>Banks</label>
                                    <select name="cr_bank_id" id="" class="form-control selectpicker"
                                        data-container="body" data-live-search="true" required>
                                        <option value="">Choose One</option>
                                        @isset($data['banks'])
                                            @foreach ($data['banks'] as $bank)
                            ...
                            <div class="col-sm-6 client-ac" style="display: none">
                                <div class="form-group">
                                    <label>Customers</label>
                                    <select name="cr_client_id" id="" class="form-control selectpicker"
                                        data-container="body" data-live-search="true" required>
                                        <option value="">Choose One</option>
                                        @isset($data['customer'])
                                            @foreach ($data['customer'] as $customer)
                            ...
                            <div class="col-sm-6 vendor-ac" style="display: none">
                                <div class="form-group">
                                    <label>Vendors</label>
                                    <select name="cr_vendor_id" id="" class="form-control selectpicker"
                                        data-container="body" data-live-search="true" required>
                                        <option value="">Choose One</option>
                                        @isset($data['vendors'])
                                            @foreach ($data['vendors'] as $vendor)
                            ...
                            <div class="col-sm-6 expense-ac" style="display: none">
                                <div class="form-group">
                                    <label>Expenses</label>
                                    <select name="cr_expense_id" id="" class="form-control selectpicker"
                                        data-container="body" data-live-search="true" required>
                                        <option value="">Choose One</option>
                                        @isset($data['level4'])
                                            @foreach ($data['level4'] as $head)
                            ...
                            <div class="col-sm-6 liability-ac" style="display: none">
                                <div class="form-group">
                                    <label>Liability</label>
                                    <select name="cr_liability_id" id="" class="form-control selectpicker"
                                        data-container="body" data-live-search="true" required>
                                        <option value="">Choose One</option>
                                        @isset($data['liability'])
                                            @foreach ($data['liability'] as $head)
                            ...
                            <div class="col-sm-6 assets-ac" style="display: none">
                                <div class="form-group">
                                    <label>Assets</label>
                                    <select name="cr_assets_id" id="" class="form-control selectpicker"
                                        data-container="body" data-live-search="true" required>
                                        <option value="">Choose One</option>
                                        @isset($data['assets'])
                                            @foreach ($data['assets'] as $head)
                    ...
                    <table class="table table-striped" id="journal-vochars-list">
                        ...
                        <tbody>
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a href="{{ url('rv') . '/' . $jv['id'] }}" title="Print"
                                                        class="dropdown-item bg-inverse-primary"><i class="fa fa-print"
                                                            aria-hidden="true"></i></a>&nbsp;
                                                    <a title="Edit" href="{{ url('edit-jv') . '/' . $jv['id'] }}"
                                                        class="dropdown-item bg-inverse-primary"> <i class="fa fa-edit"
                                                            aria-hidden="true"></i></a>
                                                </div>
                                            </div>
                                        </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <div class="float-right"> <strong> {{ number_format($subTotal, 2) }} PKR</strong>
                                    </div>
                                </td>
                            </tr>
                        </tbody>
