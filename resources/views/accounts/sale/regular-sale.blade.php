...
@section('content')
    ...
    <div class="page-wrapper">
        ...
        <div class="content container-fluid">
            ...
            <div class="card">
                <form action="{{url('regular-sale')}}" method="post" id="purchaseForm" class="needs-validation" novalidate>
                        @csrf
                        <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-3 leads-section" style="display: none">
                                <div class="form-group">
                                    ...
                                    <select name="lead_id" class="form-control selectpicker"
                                        ...
                                        @isset($data)
                                            @foreach ($data['leadsMarketings'] as $lead)
                                ...
                                <div class="col-md-3 sp-section" style="display: none">
                                    <label for="">Sales Person</label>
                                            <select name="sp_id" class="form-control selectpicker"
                                                ...
                                                <option value="" selected>Choose City</option>
                                                @isset($data)
                                                    @foreach ($data['salesPerson'] as $csr)
...
{{--                                                    <option value="{{$item->id}}">{{$item->products['item'] .'-'. $item->reg_no}}</option>--}}
{{--                                                @endforeach--}}
{{--                                            @endisset--}}
                                        </select>
                                    </td>
