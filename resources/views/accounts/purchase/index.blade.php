            ...
            <div class="page-header my-header">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto float-right ml-auto">
                        <a href="{{url('/purchase-list')}}" class="btn add-btn" title="Products List"><i class="fa fa-list" aria-hidden="true"></i></a>
                    </div>
                </div>
            </div>
            <div class="card">
                        ...
                        <div class="row">
                                <table class="table table-style">
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" class="form-control reg-no" placeholder="File No" name="reg_no[]" required ></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="number" class="form-control grandTotal" placeholder="0.00" name="grand_total" readonly required></td>
        ...
        $(document).ready(function (){
            ...
            $('#tblPurchase').on('change','.item-id', function() {
                ...
                $.ajax({
                    ...
                    data: {product_id: item_id,mode:1},
                    async: false,
                    dataType: 'json',
            ...
            $('select[name=vendor_id]').on('change', function() {
                ...
                $.ajax({
                    ...
                    data: {ac_id: ac_id,ac_type:'vendors'},
                    async: false,
                    dataType: 'json',
                    success: function(data) {
