...
@section('content')
    ...
    <div class="page-wrapper">
        ...
        <div class="content container-fluid">
            <div class="page-header my-header">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto float-right ml-auto">
                        <a href="{{url('/expense-summary')}}" class="btn add-btn" title="Expense Summary"><i class="fa fa-list" aria-hidden="true"></i></a>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <form method="post" id="expenseForm" action="{{url('manage-expense')}}" class="needs-validation" novalidate enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-3">
                        ...
                        <div class="row">
                            ...
                            <table class="table table-bordered mt-5 table-style">
                                ...
                                <tr>
                                    ...
                                    <td><input type="number" class="form-control amount" placeholder="0.00" name="amount[]" required ></td>
