                ...
                <table class="table" id="printCard">
                    <tr>
                        <td class="text-center" colspan="5">
                            <h4>THE A TEAM</h4>
                            <h5>{{($data['cheque_status']==1)?'POSTED':''}} {{strtoupper($data['trans_mode'])}} {{strtoupper($data['trans_type'])}} VOUCHER</h5>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="3"><h5>Date: {{$data['date']}}</h5> </td>
                        <td><h5>Voucher No: {{$data['trans_id']}}</h5> </td>
                    </tr>
                    <tr id="debit">
                    ...
                    <tr>
                        <td colspan="5" class="mt-5">REMARKS: {{$data['remarks']}}</td>
                    </tr>
                    ...
                    <tr>
                        <td>PREPARED BY : {{$data['prepared_by']}}</td>
                        <td>CHECKED BY</td>
                        <td>APPROVED BY</td>
