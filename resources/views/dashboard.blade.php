...
{{--												<span class="text-success">+10%</span>--}}
										...
										<h3 class="mb-3">{{$data['recentEmployee']->count()}}</h3>
...
{{--												<span class="text-success">+12.5%</span>--}}
										...
										<h3 class="mb-3">RS {{$data['expenses']}}</h3>
										<div class="progress mb-2" style="height: 5px;">
											<div class="progress-bar bg-primary" role="progressbar" style="width: 70%;" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
										</div>
										<p class="mb-0">This Month <span class="text-muted"></span></p>
									</div>
								</div>
...
{{--												<span class="text-danger">-2.8%</span>--}}
										...
										<h3 class="mb-3">{{$data['tickets']->count()}}</h3>
										<div class="progress mb-2" style="height: 5px;">
											<div class="progress-bar bg-primary" role="progressbar" style="width: 70%;" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
										</div>
										<p class="mb-0">This Month <span class="text-muted"></span></p>
...
{{--												<span class="text-danger">-75%</span>--}}
										...
										<h3 class="mb-3">{{$data['jobs']->count()}}</h3>
										<div class="progress mb-2" style="height: 5px;">
											<div class="progress-bar bg-primary" role="progressbar" style="width: 70%;" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
										</div>
										<p class="mb-0">This Month <span class="text-muted"></span></p>
								...
								<div class="card-body" >
									...
									<div class="leave-info-box">
										<div class="media align-items-center">
											<a href="profile.html" ><img class="avatar" alt="" src="{{asset('storage/app/public/uploads/staff-images/').'/'.$att->image}}"></a>
