                ...
                <table class="table" id="printCard">
                    <tr>
                        <td class="text-center" colspan="5">
                            <h4>The a Team</h4>
                            <h5>BANK RECEIPT VOUCHER</h5>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="3"><h5>Date :</h5> </td>
                        <td><h5>Voucher No :</h5> </td>
                    </tr>
                    <tr id="debit">
                        <td colspan="5"></td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="2">ACCOUNTING DESCRIPTION</td>
                        <td>AMOUNT</td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="5" class="mt-5">PURPOSE O PAYMNT: </td>
                    </tr>
