                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a href="#" class="dropdown-item btn_edit_training" data="{{ $train->id }}" id="btn_edit_clients"><i class="la la-pencil" style="font-size: 20px;"></i></a>
                                                    <a href="#" class="dropdown-item btn_delete_training" data="{{ $train->id }}" id="btn_delete_clients"><i class="la la-trash" style="font-size: 20px;"></i></a>
