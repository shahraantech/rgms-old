                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto float-right ml-auto">
                            <a type="submit" class="btn btn-primary" data-toggle="modal"
                               data-target="#create_user" title="Create User"><i class="fa fa-plus"></i></a>
                        </div>
                    </div>
                </div>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu">
                                                        <a class="dropdown-item btn-change-role"  href="" emp-id="{{ $user->id }}" data-toggle="modal" data-target="#change_role_modal" data=""> <i class="fa fa-clock-o m-r-5 text-success"></i>Change Role</a>
                                                    <a class="dropdown-item btn-status" href="#" data="{{ $user->id }}"
                                                       status="1"><i class="fa fa-clock-o m-r-5 text-success"></i>Active</a>

                                                    <a class="dropdown-item btn-status" href="#" data="{{ $user->id }}"
                                                       status="0"><i class="fa fa-clock-o m-r-5 text-danger"></i>InActive</a>
                                                </div>
                                            </div>
                                        </td>
                    ...
                    <div class="modal-body">
                        <form method="post" action="{{ url('create-user') }}" id="userForm" class="needs-validation"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="role_id" id="" class="form-control role-class" required>
                            ...
                            <div class="submit-section">
                                <button class="btn btn-primary submit-btn" id="btnSubmit" type="submit">Create</button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                            ...
                            <form method="post" action="{{ url('update-user-role') }}" id="changeRoleFormData" class="needs-validation"
                                  novalidate>
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Role <span class="text-danger">*</span></label>
                                        <select name="change_role_id" id="" class="form-control role-class" required>
                                            <option value="">Choose Role</option>
                                            @isset($data)
                                                @foreach ($data['roles'] as $role)
                                                    <option value="{{ $role->id }}">{{ $role->role }}</option>
                            ...
                            <div class="submit-section">
                                <button class="btn btn-primary submit-btn" id="btnSubmit" type="submit">Change</button>
                            </div>
                        </form>
                    </div>
                </div>
