        ...
        <div class="page-header">
            <div class="row align-items-center">
                ...
                <div class="col-auto float-right ml-auto">
                    <a href="#" class="btn add-btn" data-toggle="modal" data-target="#add_department"><i class="fa fa-plus"></i> Add Grades</a>
                </div>
            </div>
        </div>
        <!-- /Page Header -->
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" class="close btn-dismiss" data-dismiss="modal" aria-label="Close" id="modalDismiss">
                ...
                <div class="modal-body">
                    <form method="post" action="" id="gradeForm" class="needs-validation" novalidate>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="grade" placeholder="Grades Name" required>
                        </div>
                        <div class="form-group">
                            <label> Grade Category <span class="text-danger">*</span></label>
                            <input class="form-control" type="text" name="grade_cat" placeholder="Grade Category Name" required>
                        </div>
...
<script>
    $(document).ready(function() {
                ...
                success: function(data) {
                    ...
                    for (i = 0; i < data.length; i++) {
                        ...
                        html += '<tr>' +
                            ...
                            '<a class="dropdown-item btn-edit" href="#" data-toggle="modal" data-target="#edit_department" data="' + data[i].id + '"><i class="fa fa-pencil m-r-5n "></i> Edit</a>' +
        ...
        $('#gradeForm').unbind().on('submit', function(e) {
            e.preventDefault();
