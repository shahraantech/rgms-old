		...
		<div class="page-header">
			<div class="row align-items-center">
				...
				<div class="col-auto float-right ml-auto">
					<a href="#" class="btn add-btn" data-toggle="modal" data-target="#add_leave" title="Create Leave Request"><i class="fa fa-plus"></i></a>
				</div>
			</div>
		</div>
		<!-- /Page Header -->
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form method="post" action="" class="needs-validation" novalidate id="leaveForm">
						@csrf
<div class="row">
                            <div class="col-md-12">
				...
				success: function(data) {
					...
					for (i = 0; i < data.length; i++) {
						...
						html += '<tr>' +
							...
							' <a href="{{url("my-profile")}}"><img class="target-img" alt="" src="storage/app/public/uploads/staff-images/' + data[i].image + '"></a>' +
							...
							' <span class="badge bg-inverse-success">'+data[i].leave_status + '</span>' +
							'</td>' +
							...
							'<a href="#" class="dropdown-item btn_edit_leave" data="' + data[i].id + '" id="btn_edit_clients"><i class="fa fa-pencil m-r-5n "></i> Edit</a>' +
							'<a href="" class="dropdown-item btn_delete_leave" data="' + data[i].id + '" id="btn_delete_clients"><i class="fa fa-trash-o m-r-5 "></i> Delete</a>' +
			...
			$.ajax({
				...
				success: function(data) {
					...
					$('select[name="leave_type"]')
                        .append(`<option value="Casual Leave 12 Days" ${'Casual Leave 12 Days' == data.leave_type ? 'selected' : ''}>Casual Leave 12 Days</option>` +
