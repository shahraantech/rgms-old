...
@section('content')
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="post" id="newHiringForm" action="{{ url('save-new/hiring') }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-4">
                                        ...
                                        <select class="form-control select selectpicker" name="dept_name" id="showDept"
                                    ...
                                    <div class="form-group col-sm-4">
                                        ...
                                        <select class="form-control selectpicker select" id="showDesig" name="designation"
                                            data-container="body" data-live-search="true">
                                ...
                                <div class="submit-section">
                                    <button class="btn btn-primary submit-btn btn_save_job" type="submit"
    ...
    <script type='text/javascript'>
        $(document).ready(function() {
            ...
            $('#newHiringForm').on('submit', function(e) {
                e.preventDefault();
