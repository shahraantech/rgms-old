        ...
        <div class="page-header">
            <div class="row align-items-center">
                ...
                <div class="col-auto float-right ml-auto">
                    <a href="{{url('recruitment/new/form')}}" class="btn add-btn"><i class="fa fa-plus"></i>Create Job</a>
                </div>
            </div>
        </div>
        <!-- /Page Header -->
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    for (i = 0; i < data.length; i++) {
                        ...
                        (data[i].status == 'OPEN') ? status_class = 'text-success': status_class = 'text-danger';
                        ...
                        html += '<tr>' +
                            ...
                            '<td class="d-none d-sm-table-cell col-md-4">' + data[i].desc.substring(0, 100) + '</td>' +
                            '<td class="text-center">' +
                            '<div class="action-label">' +
                            '<a class="btn btn-white btn-sm btn-rounded" href="#" data-toggle="dropdown" aria-expanded="false">' +
                            '<i class="fa fa-dot-circle-o ' + status_class + '"></i>' + data[i].status + ' </a>' +
                            '</div></td>' +
                            ...
                            '<a class="dropdown-item btnEdit" href="{{url("edit-recruitment/")}}/' + data[i].id + '"><i class="fa fa-pencil m-r-5"></i> Edit</a>' +
                            ...
                            '<div  target="_blank">{!! Share::page(url("https://rgms.shahraantech.com/job/list/"))->facebook()->twitter()->whatsapp()->linkedin() !!}</div>' +
                            '</div>' +
                            '</div>' +
                            '</td>' +
                ...
                success: function(data) {
                    ...
                    for (i = 0; i < data.length; i++) {
                        ...
                        html += '<tr>' +
                            ...
                            '<div class="dropdown-menu dropdown-menu-right">' +
                            '<a class="dropdown-item btnEdit" href="{{url("edit-recruitment/")}}/' + data[i].id + '"><i class="fa fa-pencil m-r-5"></i> Edit</a>' +
                            '<a class="dropdown-item btn-delete" href="#" data-toggle="modal"  data="' + data[i].id + '"><i class="fa fa-trash-o m-r-5"></i> Delete</a>' +
                            '</div>' +
                            '</div>' +
                            '</td>' +
