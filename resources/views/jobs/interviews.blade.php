            ...
            <div class="card">
                <div class="card-body">
                    <div class="container py-4">
                        <form action="{{ url('interviews') }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-md-3">
                                            ...
                                            <td class="">
                                                <div class="dropdown dropdown-action">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item btnInterview" href="javascript:" data="{{$interviews->interviewId}}"><i class="fa fa-clock-o m-r-5 text-success"></i> Re Schedulee</a>
