                ...
                success: function(data) {
                    ...
                    for (i = 0; i < data.length; i++) {
                        ...
                        html += '<tr>' +
                            ...
                            '<a class="dropdown-item btn-status" href="#" data-toggle="modal" data-target="#edit_department" data="' + data[i].id + '" status="accept"><i class="fa fa-pencil m-r-5n "></i> Accept</a>' +
                            '<a class="dropdown-item btn-status" href="#" data-toggle="modal" data-target="#delete_department" data="' + data[i].id + '" status="reject"><i class="fa fa-trash-o m-r-5 "></i> Reject</a>' +
                            '</div>' +
                            '</div>' +
                            '</td>' +
