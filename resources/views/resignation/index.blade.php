...
<script>
    $(document).ready(function() {
                ...
                success: function(data) {
                    ...
                    for (i = 0; i < data.length; i++) {
                        ...
                        html += '<tr>' +
                            ...
                            '<a href="my-profile" ><img class="target-img" alt="" src="storage/app/public/uploads/staff-images/'+data[i].image+'"></a>' +
                            ...
                            '<a class="dropdown-item btn_edit_reg" href="#" data-toggle="modal"  data="' + data[i].id + '"><i class="fa fa-pencil m-r-5n "></i> Edit</a>' +
                            '<a class="dropdown-item btn_delete_reg" href="#" " data="' + data[i].id + '"><i class="fa fa-trash-o m-r-5 "></i> Delete</a>' +
                            '</div>' +
                            '</div>' +
                            '</td>' +
        ...
        $('#resigForm').on('submit', function(e) {
            ...
            var formData = $('#resigForm').serialize();
