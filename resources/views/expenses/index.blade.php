            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    for (i = 0; i < data.length; i++) {
                        ...
                        c++;
                        (data[i].status == 'APPROVED') ? status_class = 'text-success': status_class = 'text-danger';
                        ...
                        html += '<tr>' +
                            ...
                            ' <td><img src="{{asset("storage/app/public/uploads/expense-bills")}}/' + data[i].expense_bill + '" style="height:45px; width:50px" class="img img-thumbnail"></td>' +
                            ...
                            '<a class="dropdown-item btn-approve" href="#"  status="approved" data="' + data[i].id + '"><i class="fa fa-pencil m-r-5n "></i> Approve</a>' +
                            '<a class="dropdown-item btn-approve" href="#" status="reject" " data="' + data[i].id + '"><i class="fa fa-trash-o m-r-5 "></i> Reject</a>' +
                            '</div>' +
                            '</div>' +
                            '</td>' +
                            '</tr>';
