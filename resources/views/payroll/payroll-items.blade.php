        ...
        <div class="tab-content">
            ...
            <div class="tab-pane show active" id="tab_additions">
                ...
                <div class="text-right mb-4 clearfix">
                    <button class="btn btn-primary add-btn" type="button" data-toggle="modal" data-target="#add_addition" title="Create Allowance"><i class="fa fa-plus"></i> </button>
                </div>
                <!-- /Add Addition Button -->
            ...
            <div class="tab-pane" id="tab_overtime">
                <!-- Add Overtime Button -->
                <div class="text-right mb-4 clearfix">
                    <button class="btn btn-primary add-btn" type="button" data-toggle="modal" data-target="#add_overtime" title="assign allowance"><i class="fa fa-plus"></i></button>
                </div>
                <!-- /Add Overtime Button -->
                                    ...
                                    <td>
                                        <ul style="list-style-type: none">
                                            <li>
                                                ...
                                                @if($allData)
                                                <span class="badge bg-inverse-success"> {{$allData->allowance}}</span>
                                                @endif
                                                @endforeach
                                            </li>
                                        </ul>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="{{url('payroll-items')}}" id="allowanceForm" class="needs-validation">
...
<div id="add_overtime" class="modal custom-modal fade" role="dialog">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="{{url('payroll-items')}}" id="empAllowanceForm" class="needs-validation">
                    <input type="hidden" name="empAllowanceForm" value="1">
                    <div class="form-group">
                        <label>Employee <span class="text-danger">*</span></label>

                        <select name="emp_id" class="form-control selectpicker" data-container="body" data-live-search="true" title="Choose  Employee">
                    ...
                    <div class="form-group">
                        <label>Allowance <span class="text-danger">*</span></label>
                        <select class="form-control form-control-sm select2" multiple="multiple" name="allowance_id[]" required>
                            <option></option>
                            @isset($data)
                    ...
                    <div class="form-group">
                        <label>Allowance <span class="text-danger">*</span></label>
                        <input type="number" name="allowance_percent" placeholder="Allowance in amount" class="form-control">
                    </div>
                    <div class="submit-section">
...
<script>
    $(document).ready(function() {
                ...
                success: function(data) {
                    ...
                    for (i = 0; i < data.length; i++) {
                        ...
                        html += '<tr>' +
                            ...
                            '<a class="dropdown-item btn_edit_allowance" href="#" data-toggle="modal"  data="' + data[i].id + '"><i class="la la-pencil" style="font-size: 20px;"></i></a>' +
                            '<a class="dropdown-item btn_delete_allowance" href="#" " data="' + data[i].id + '"><i class="la la-trash" style="font-size: 20px;"></i></a>' +
                            '</div>' +
                            '</div>' +
                            '</td>' +
                            '<tr>';
        ...
        $('#empAllowanceForm').unbind().on('submit', function(e) {
            e.preventDefault();
            var formData = $('#empAllowanceForm').serialize();
            $.ajax({
