            ...
            $.ajax({
                ...
                success: function(report) {
                    ...
                    for (i = 0; i < report.length; i++) {
                        ...
                        (report[i]['status']=='Present')? className='success': className='danger';
                        c++;
                        html +='<tr>'+
                            '<td>'+c+'</td>'+
                        '<td>'+
                        '<h2 class="table-avatar">'+
                        '<a href="#"><img alt="" class="target-img" src="storage/app/public/uploads/staff-images/' + report[i].image + '"></a>'+
                        ...
                        '<td>'+
                        '<span class="badge bg-inverse-'+className+'">'+report[i]['status']+'</span>'+
                        '</td>'+
                        '<td><span class="badge bg-inverse-info">'+report[i]['marked_by']+'</span></td>'+
                        '<td><span class="badge bg-inverse-primary">'+report[i]['guard']+'</span></td>'+
                        '</tr>';
                    }
